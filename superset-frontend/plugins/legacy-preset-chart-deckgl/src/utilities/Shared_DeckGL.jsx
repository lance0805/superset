...
export const mapboxStyle = {
  ...
  config: {
    ...
    choices: [
      ['mapbox://styles/mapbox/streets-v11', t('Streets')],
      ['mapbox://styles/mapbox/dark-v11', t('Dark')],
      ['mapbox://styles/mapbox/light-v11', t('Light')],
      ['mapbox://styles/mapbox/satellite-streets-v11', t('Satellite Streets')],
      ['mapbox://styles/mapbox/satellite-v11', t('Satellite')],
      ['mapbox://styles/mapbox/outdoors-v11', t('Outdoors')],
    ],
